...
(
	...
	book_id int NOT NULL FOREIGN KEY REFERENCES BOOKSHELF(book_id),
...
(10012, 'John', 'Doe', 'johndoe@gmail.com');
...
--Could add category table to make things simple/complicated depending on the view
--Same thing with author table

--https://www.youtube.com/watch?v=yldrIdoXiYk